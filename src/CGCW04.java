...
//			T.LookAt(0, 0, 0, 0, 0, -100, 0, 1, 0);  	//Default
			...
			//as suggested in the coursework description, and draw it
			//Create a cone and change its scale, translate it, and rotate it to orient it properly beneath
			//the sphere.
			T.scale(1f, 1f, 1f);
			T.translate(0f, -1f, -0.4f);
			T.rotateZ(180);
			T.rotateX(270f);
			...
			//send other uniform variables to shader (for the cone)
			...
			//adjust its ID's becuase it should identify differently from the sphere
			idPoint=1;
			idBuffer=1;
			idElement=1;
			bindObject(gl);
		...
		public void init(GLAutoDrawable drawable) {
			...
			//Create a cone and change it's ID
			SObject square = new SSquare(1);
			idPoint=1;
			idBuffer=1;
			idElement=1;
			createObject(gl, square);

			// Set Cone material to a light blue
			...
			//set variables for graphical output to use
